...
export default function CarouselBanner(props: Readonly<CarouselBannerProps>) {
  ...
  return (
    <div className={`relative w-full ${className}`}>
      <div className="group relative w-full aspect-3/1 md:h-75 lg:h-87.5 md:aspect-auto overflow-hidden rounded-2xl md:rounded-4xl shadow-lg transition-all hover:shadow-xl bg-gray-100">
        {/* Slider Track */}
        <div
          ...
          {slides.map((slide) => (
            <div key={slide.id} className="relative h-full min-w-full">
              <img
                ...
                className="absolute object-fill lg:object-cover"
