...
export default function ButtonDropdown(props: Readonly<ButtonDropdownProps>) {
  ...
  `}
      >
        <div className="w-fit min-w-66 bg-background-disabled font-normal text-white text-[16px] p-2 rounded-xl text-left leading-relaxed whitespace-normal wrap-break-word">
          {children || (
