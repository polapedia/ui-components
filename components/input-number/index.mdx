...
The **InputNumber** component is a numeric stepper that lets users increase or decrease a numeric value using plus/minus controls, while still supporting direct keyboard input.
