...
The stepper is controlled via the `activeIndex` prop, so it works well with “Next / Back / Reset” patterns.
...
> The stepper itself is presentational only — the “current step” logic lives in the parent.
...
- **Labels & prefixes**
  ...
  - Keep `label` concise and action-oriented (e.g. “Shipping Details”, “Review Order”).
  - Use `prefix` for secondary context: “Step 1”, “+1”, “01”, etc.
